...
export function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-background/95 via-background/80 to-background/95 backdrop-blur-md border-b border-border">
